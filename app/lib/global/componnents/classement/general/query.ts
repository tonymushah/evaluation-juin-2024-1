...
import type { Equipe } from '$lib/admin/gql/graphql';
import { graphql } from '$lib/global/gql';
import type { CoueurPoint, EquipePoint, GraphQlOrdering } from '$lib/global/gql/graphql';
import { getContextClient, type CombinedError } from '@urql/svelte';
